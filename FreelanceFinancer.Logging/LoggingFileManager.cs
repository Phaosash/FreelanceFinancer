...
internal class LoggingFileManager {
    private readonly Lock _fileLock = new();
    private readonly int _fileRetentionPeriod;
    private readonly string _logsDirectory;

    public LoggingFileManager (int logRetentionPeriod){
        _fileRetentionPeriod = logRetentionPeriod;
        _logsDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "logs");
        CleanUpOldLogs(_fileRetentionPeriod);
    }
